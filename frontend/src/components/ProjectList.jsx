...
const ProjectList = () => {
  ...
  return (
        ...
        <ProjectListWrapper>
            ...
            <ProjectListContent>
                ...
                <ProjectListTitle key={project._id}>
                    <Link style={{color:'var(--blackjsdarker)'}} to={`/projects/${project._id}`}>
                        <h3>{project.title}</h3>
    ...
    : 
        <ProjectListWrapper>
            <h1><span style={{color:'var(--yellowjs)', fontWeight: '400'}}>Bee</span>busy</h1> 
            <p><StyledLink to="/login">Inicia sesión</StyledLink> o <StyledLink to="/register">regístrate</StyledLink></p> 
            <img
                src={image}
